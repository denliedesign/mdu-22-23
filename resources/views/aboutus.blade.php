...
@section('content')
    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            <div class="row">
                <div class="col-sm">
                    <img src="/images/about-us-mistys-dance.jpg" alt="" class="img-fluid shadow rounded mb-2">
                </div>
                <div class="col-sm">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-4">
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-misty.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-abby.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-addi.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                    ...
                    <p class="font-syne">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium adipisci aspernatur assumenda aut commodi corporis culpa cum debitis delectus dolorem dolores ea error est ex impedit ipsam ipsum maiores minima, minus molestiae molestias natus provident quae quam repellat soluta sunt temporibus unde voluptas voluptatum. Nesciunt optio recusandae voluptatem? Quod, saepe!
                    </p>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-4">
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-alex.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-amanda.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-amy.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-beth.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                        <div class="triangle-text font-staat m-2" style="font-size: 30px; line-height: 0.9em; position: absolute; bottom: 0; left: 0;">Miss<br>Beth Michelson</div>
                    </div>
                    <p class="font-syne">
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-carmina.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                    ...
                    <p class="font-syne">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad animi architecto asperiores assumenda cum delectus deserunt doloremque ea, eaque earum eius eligendi esse est et fugit, impedit in, iure mollitia nemo optio quas saepe sapiente similique tempore velit vitae voluptatibus voluptatum. Atque cupiditate dicta dolorum est ipsum natus obcaecati quod!
                    </p>
                </div>
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-chloe-jane.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                    ...
                    <p class="font-syne">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis dolore ducimus enim, exercitationem illum minima quae quaerat voluptate. Asperiores blanditiis consequatur cum deleniti dicta doloribus eius eos explicabo fugiat, incidunt nemo non, quae quidem quis ratione repellendus veritatis. A commodi deleniti doloribus ducimus et iure maxime minima quae reiciendis repudiandae.
                    </p>
                </div>
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-cindy.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-denise.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-dennis.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-emily.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-emma.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-grace.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-greta.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-hannah.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-katelyn.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-kaydra.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-kris.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-kristina.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-kyla.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-kylie.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-larissa.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-lexi.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-madeline.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                        <div class="triangle-text font-staat m-2" style="font-size: 30px; line-height: 0.9em; position: absolute; bottom: 0; left: 0;">Miss<br>Melanie Earll</div>
                    </div>
                    <p class="font-syne">
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-michelle.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-nicole.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-richard.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-sandy.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-shayna.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-suzanne.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
                ...
                <div class="col-sm mt-3 text-white" style="height: 100%;">
                    <div style="position: relative;">
                        <img src="/images/staff-tiffany.jpg" alt="staff member" class="img-fluid" style="max-height: 382.50px;">
                        <div id="triangle-bottomleft-staff"></div>
